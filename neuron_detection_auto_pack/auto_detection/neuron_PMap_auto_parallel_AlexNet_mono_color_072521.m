function [score_result]=neuron_PMap_auto_parallel_AlexNet_mono_color_072521(net,img,major_slice_area,patch_size,chan_todo)
...
%     score_result_t=score_result_t/quantile(score_result_t,0.99);
%     score_result_t(score_result_t>1)=1;
%     score_result_t(score_result_t<0.4)=0;
    toc;
